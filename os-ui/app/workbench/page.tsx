...
// Server component: gates the Workbench tab on the OS role + the feature flag
// BEFORE shipping any client code, then hands off to the client launcher. The
// session route (/api/workbench/session) re-checks role AND domain membership —
// defence in depth.
...
export default async function WorkbenchPage() {
  ...
  const authorised = !!user && config.workbenchAllowedRoles.includes(user.role);
